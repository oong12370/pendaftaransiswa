                            ...
                            <tbody>
                              ...
                              ?>
                                                      <tr>
                                                                  ...
                                                                  <td><?php echo $rows['deskkripsi'] ?></td>
                                                                  ...
                                                                  <td>
                                                                        ...
                                                                        <a href="include/hapus_pengumuman.php?id=<?php echo $rows['id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
                                                                  </td>
                                                            </tr>
                              <?php
                                                }
